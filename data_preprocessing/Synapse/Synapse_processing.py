...
def slice_and_save_nifti_z_axis(image_path, label_path, save_dir):
    ...
    # Reorient image and label to RAS
    ...
    # Normalize to [0, 1] and scale to [-1, 1] for the image
